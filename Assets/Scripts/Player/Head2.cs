...
public class Head2 : MonoBehaviour
{
	...
	void Start()
	{
        ...
        player = GetComponentInParent<P2>();
	}
	...
	void Animation()
	{
        if (player.dashState == P2.DashState.Dashing)
		{
		...
		else if (Input.GetAxis("P2_RightJoystickHorizontal") > 0 && Input.GetAxis("P2_RightJoystickVertical") < 0)
		{
			//TopRight
