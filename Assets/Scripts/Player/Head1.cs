...
public class Head1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player = GetComponentInParent<P1>();
    }
    ...
    void Animation()
    {
        if(player.dashState == P1.DashState.Dashing){
        ...
        else if (Input.GetAxis("P1_RightJoystickHorizontal") > 0 && Input.GetAxis("P1_RightJoystickVertical") < 0)
        {
            //TopRight
