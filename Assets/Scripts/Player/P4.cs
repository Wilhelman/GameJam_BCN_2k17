...
public class P4 : MonoBehaviour
{
	...
	void Start()
	{
		...
		bullet = GameObject.Find("Bullet4");
	...
	void Update()
	{
		if (!isSad)
		{
			if (Input.GetAxis("P4_RightJoystickHorizontal") != 0 || Input.GetAxis("P4_RightJoystickVertical") != 0)
			{
				time -= Time.deltaTime;
	...
	void Movement()
	{
		...
		inputDirection.x = Input.GetAxis("P4_LeftJoystickHorizontal");
		inputDirection.y = (-1) * Input.GetAxis("P4_LeftJoystickVertical");
	...
	void Shoot()
	{
        ...
        bulletDirection.x = Input.GetAxis("P4_RightJoystickHorizontal");
		bulletDirection.y = (-1) * Input.GetAxis("P4_RightJoystickVertical");
	...
	{
		if (Input.GetAxis("P4_LeftJoystickHorizontal") > 0 && Input.GetAxis("P4_LeftJoystickVertical") > 0)
		{
			//DownRight
			movementDirection = Directions.DownRight;

		}
		else if (Input.GetAxis("P4_LeftJoystickHorizontal") > 0 && Input.GetAxis("P4_LeftJoystickVertical") < 0)
		{
			//TopRight
