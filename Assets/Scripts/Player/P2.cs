...
public class P2 : MonoBehaviour
{
	...
	void Start()
	{
		...
		bullet = GameObject.Find("Bullet2");
	...
	void Update()
	{
		if (!isSad)
		{
			if (Input.GetAxis("P2_RightJoystickHorizontal") != 0 || Input.GetAxis("P2_RightJoystickVertical") != 0)
			{
				time -= Time.deltaTime;
	...
	void Movement()
	{
		...
		inputDirection.x = Input.GetAxis("P2_LeftJoystickHorizontal");
		inputDirection.y = (-1) * Input.GetAxis("P2_LeftJoystickVertical");
	...
	void Shoot()
	{
        ...
        bulletDirection.x = Input.GetAxis("P2_RightJoystickHorizontal");
		bulletDirection.y = (-1) * Input.GetAxis("P2_RightJoystickVertical");
	...
	{
        if (Input.GetAxis("P2_LeftJoystickHorizontal") > 0 && Input.GetAxis("P2_LeftJoystickVertical") > 0)
        {
            //DownRight
            movementDirection = Directions.DownRight;

        }
        else if (Input.GetAxis("P2_LeftJoystickHorizontal") > 0 && Input.GetAxis("P2_LeftJoystickVertical") < 0)
        {
            //TopRight
