...
public class P3 : MonoBehaviour
{
	...
	void Start()
	{
		...
		bullet = GameObject.Find("Bullet3");
	...
	void Movement()
	{
		...
		inputDirection.x = Input.GetAxis("P3_LeftJoystickHorizontal");
		inputDirection.y = (-1) * Input.GetAxis("P3_LeftJoystickVertical");
	...
	void Shoot()
	{
        ...
        bulletDirection.x = Input.GetAxis("P3_RightJoystickHorizontal");
		bulletDirection.y = (-1) * Input.GetAxis("P3_RightJoystickVertical");
	...
	{
		if (Input.GetAxis("P3_LeftJoystickHorizontal") > 0 && Input.GetAxis("P3_LeftJoystickVertical") > 0)
		{
			//DownRight
			movementDirection = Directions.DownRight;

		}
		else if (Input.GetAxis("P3_LeftJoystickHorizontal") > 0 && Input.GetAxis("P3_LeftJoystickVertical") < 0)
		{
			//TopRight
